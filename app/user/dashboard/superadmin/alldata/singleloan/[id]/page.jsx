                  ...
                  <li className='text-gray-400 text-sm hover:underline'>
                    ...
                    {loan.applicant_aadharcard && loan.applicant_aadharcard.map((imgUrl, idx) => (
                      <Link key={idx} href={imgUrl} target='_blank' className='flex gap-2'>
                        <Image src={imgUrl} alt={`img-${idx}`} width={20} height={20} className="object-cover rounded" />AadharCard
                      </Link>
                    ))}
                  </li>
                  <li className='text-gray-400 text-sm hover:underline'>
                ...
                <ul className='grid grid-cols-2 gap-2'>
                  ...
                  <li className='text-gray-400 text-sm hover:underline'>
                    ...
                    {loan.guarantor_aadharcard && loan.guarantor_aadharcard.map((imgUrl, idx) => (
                      <Link key={idx} href={imgUrl} target='_blank' className='flex gap-2'>
                        <Image src={imgUrl} alt={`coapplicant_voterid-img-${idx}`} width={20} height={20} className="object-cover rounded" />Guarantor Aadhar card
                      </Link>
                    ))}
