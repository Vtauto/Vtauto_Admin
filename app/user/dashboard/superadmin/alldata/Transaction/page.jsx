...
export default function Page() {
    ...
    return (
        <>
            <div className="container lg:p-8 mx-auto mt- px-4">
                <h1 className='text-4xl font-bold mb-4 text-gray-600'>Transaction</h1>
                        ...
                        {filteredUsers.map(user => (
                            <li key={user._id} className="col-span-1 divide-y divide-gray-200 rounded-lg bg-white shadow">
                                <div className="flex w-full items-center justify-between space-x-6 p-6">
                                    ...
                                    <Link href={`wallet/${user._id}`}>
                                        <button className='text-green-600 hover:bg-green-100 rounded-md px-2 py-0.5 transition-all'>
